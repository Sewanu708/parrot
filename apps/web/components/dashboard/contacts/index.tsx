  ...
  return (
    <div className="flex flex-col h-full font-sans transition-colors duration-200">
      ...
      <div className="flex-1 p-8 max-w-5xl mx-auto w-full mt-4">
        ...
        <div className="flex-1 flex items-center justify-center min-h-[400px] text-[#37352f]/40 dark:text-[#555555] text-sm border border-dashed border-neutral-200 dark:border-neutral-800 rounded-xl">
